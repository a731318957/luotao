...
async function detail(id) {
  ...
  const vod = { vod_id: input, vod_name: data.name || '酷我歌单', vod_pic: hd(data.img || data.img500), vod_content: data.info || '', vod_remarks: '听海歌单', vod_play_from: "听海歌单", vod_play_url: playArr.join('#'), vod_play_pic: songPicArr.join('#'), 
  vod_actor: '🌷',
            vod_director: '🌷',
            vod_content: '🌷',
